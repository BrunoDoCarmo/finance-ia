...
import Modal from "@/app/_components/modal"; // ajuste o caminho se necessário
import TransactionsPage from "../_transactions/transaction-client";
...
const LastTransactions = ({ lastTransactions }: LastTransactionsProps) => {
  ...
  const getAmountColor = (transaction: SerializedTransaction) => {
    ...
    if (transaction.type === "DEPOSIT") return "text-primary";
